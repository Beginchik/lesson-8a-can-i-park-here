...
export function Lesson8A({ onLessonChange: _onLessonChange }: { onLessonChange: (lesson: CourseLessonId) => void }) {
  ...
  return <div className="course-shell lesson-8a-theme">
    ...
    <div className={"lesson-nav-drawer " + (navOpen ? "is-open" : "")}>
...
function Homework(props: ExerciseProps) {
  ...
  return <section className="lesson-panel lesson-8a-homework"><Heading eyebrow="HOMEWORK · WORKBOOK 8A" title="Can I park here?" Text={Text} />
    ...
    <details className="homework-extra"><summary><span>3</span><b><Text>Pronunciation: choose the sound of can or can't.</Text></b></summary><div>
    ...
    <details className="homework-extra"><summary><span>4</span><b><Text>Complete the verb phrases.</Text></b></summary><div>
    ...
    <details className="homework-extra"><summary><span>5</span><b><Text>Write rules for places in your country.</Text></b></summary><div>
    ...
    <details className="homework-extra"><summary><span>6</span><b><Text>Complete the conversations.</Text></b></summary><div>
